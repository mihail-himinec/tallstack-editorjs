...
namespace TallStackEditorJs\Forms\Components;
...
use TallStackEditorJs\Forms\Components\Concerns\InteractsWithTools;
...
class EditorJs extends Field implements HasFileAttachmentsContract
{
    ...
    protected string $view = 'tallstack-editorjs::forms.components.fields.editorjs';
